...
void main() {
    ...
    float shadow = innerShadow(texCoord0, cornerRadius, 2.5);
    float sheen = smoothstep(0.0, 1.0, 1.0 - texCoord0.y);
    vec3 rgb = base.rgb * (0.96 + 0.06 * sheen);
    rgb -= vec3(0.01, 0.015, 0.02) * shadow;
